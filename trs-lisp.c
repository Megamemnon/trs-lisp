...
void initPrimitives(){
    ...
    addprim("hd",f_car)
    addprim("tl",f_cdr)
    addprim("alph?",f_char_alphabetic)
    addprim("num?",f_char_numeric)
    addprim("spc?",f_char_whitespace)
    addprim("upr?",f_char_upper_case)
    addprim("lwr?",f_char_lower_case)
    addprim("c->n",f_char_to_integer)
    addprim("cfl", f_close_input_port)
    addprim("cond",f_cond)
    addprim("cons",f_cons)
    addprim("df",f_define)
    addprim("dfsx",f_define_syntax)
    addprim("p",f_display)
    addprim("do",f_do)
    addprim("eof?", f_eof_object)
    addprim("eq?", f_eqv)
    addprim("n->c",f_integer_to_char)
    addprim("let",f_let)
    addprim("list", f_list)
    addprim("load",f_load)
    addprim("nl",f_newline)
    addprim("n->s", f_number_to_string)
    addprim("rfl", f_open_input_file)
    addprim("wfl", f_open_output_file)
    addprim("'", f_quote)
    addprim("rc",f_read_char)
    addprim("set!", f_set)
    addprim("sappend", f_string_append)
    addprim("s=?", f_string_eq)
    addprim("s",f_string)
    addprim("slen",f_string_length)
    addprim("subs", f_substring)
    addprim("w",f_write)
    addprim("wc",f_write_char)
